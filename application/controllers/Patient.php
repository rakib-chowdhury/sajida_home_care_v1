...
class Patient extends CI_Controller
{
    ...
    public function patient_add_post()
    {
        ...
        //print_r($this->home_care_lib->format_date($this->input->post('patient_joining_date')));die();
        if (isset($_POST['patient_joining_date']) && isset($_POST['patient_name']) && isset($_POST['patient_phone']) &&
            isset($_POST['patient_dob']) && isset($_POST['patient_address'])
        ) {
            $table_name = 'tbl_patient_user';
            $count_patient = $this->Admin_model->count_patient($table_name, $this->home_care_lib->format_date($this->input->post('patient_joining_date')));
            $count_patient = $count_patient + 1;

            $data['patient_id'] = 'PT'.$this->home_care_lib->get_id($this->input->post('patient_joining_date')).$count_patient;
            $patient_id = $data['patient_id'];
            $data['patient_name'] = $this->input->post('patient_name');
            $data['NID_number'] = $this->input->post('patient_nid');
            $data['DOB'] = $this->home_care_lib->format_date($this->input->post('patient_dob'));;
            ...
            $data['joining_date'] = $this->home_care_lib->format_date($this->input->post('patient_joining_date'));;
