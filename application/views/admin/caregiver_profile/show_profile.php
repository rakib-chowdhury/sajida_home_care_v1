                    ...
                    <div class="panel-body">
                        <div>
                            <a href="#" class="profile-picture">
                                <?php if($caregiver_info[0]->picture != null){ ?>
                                <img style="height: 120px;width: 120px"
                                     src="<?php $img = filemtime($caregiver_info[0]->picture);
                                     echo site_url($caregiver_info[0]->picture."?".$img);
                                     ?>"
                                     class="center-block img-circle"/>
                                <?php }else{ ?>
                                    <img style="height: 120px;width: 120px"
                                         src="<?= site_url('uploads/caregiver_image/no_image.jpg') ?>"
                                         class="center-block img-circle"/>
                                <?php } ?>
                            </a>
                            ...
                            <ul class="profile-info-sections list-unstyled">
                                <li>
                                    <div class="profile-name">
                                        <strong>
                                            <a href="#"><?= $caregiver_info[0]->caregiver_name ?></a>
                                        </strong><br>
                                        <span><a
                                        ...
                                        <span><a
                                                href="#"><?= $caregiver_info[0]->caregiver_user_id; ?></a></span><br>
                                        <span><a
                                                href="#"><?= $caregiver_info[0]->level_name; ?></a></span><br>
                                        <span><a
                                                href="#"><?= 'Joined On ' . $j_date = date("F, Y", strtotime($caregiver_info[0]->joining_date)); ?></a></span>
                                    </div>
                                </li>
                            </ul>
                            <hr>
                        ...
                        <ul class="user-details list-unstyled">
                            ...
                            <li>
                                <a href="#">
                                    ...
                                    <?= $b_day = date('d F, Y', strtotime($caregiver_info[0]->DOB)); ?>
                                </a>
                            </li>
                        </ul>
                    </div>
                                        ...
                                        <div id="collapseOne-2" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                <div class="col-md-10">
                                                    ...
                                                    <p class="col-sm-3"><?= $caregiver_info[0]->caregiver_name ?></p>
                                                </div>
                                                <input type="hidden" name="g_caregiver_name" id="g_caregiver_name" value="<?= $caregiver_info[0]->caregiver_name ?>">
                                                <div class="col-md-10">
                                                    <span for="patient_id" class="col-sm-3">ID</span>
                                                    <p class="col-sm-3"><?= $caregiver_info[0]->caregiver_user_id ?></p>
                                                </div>
                                                <input type="hidden" id="get_caregiver" name="get_caregiver"
                                                       value="<?= $caregiver_info[0]->caregiver_user_id ?>">
                                                <div class="col-md-10">
                                                    <span for="patient_nid" class="col-sm-3">National ID</span>
                                                    <p class="col-sm-3"><?php if($caregiver_info[0]->NID_number){echo $caregiver_info[0]->NID_number;}else{echo 'N/A';} ?></p>
                                                </div>
                                                <div class="col-md-10">
                                                    <span for="patient_dob" class="col-sm-3">Date of Birth</span>
                                                    <p class="col-sm-4"><?= $j_date = date("l, F j, Y", strtotime($caregiver_info[0]->DOB)); ?></p>
                                                </div>
                                                <div class="col-md-10">
                                                    <span for="patient_gender" class="col-sm-3">Gender</span>
                                                    <p class="col-sm-3"><?php if ($caregiver_info[0]->gender == 1) {
                                                            echo 'Male';
                                                        } else {
                                                            echo 'Female';
                                                        } ?></p>
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <p class="col-sm-3"><?= $caregiver_info[0]->phone_number ?></p>
                                                </div>
                                                <div class="col-md-10">
                                                    <span for="patient_email" class="col-sm-3">Email</span>
                                                    <p class="col-sm-3"><?php if($caregiver_info[0]->email){echo $caregiver_info[0]->email;}else{echo 'N/A';} ?></p>
                                                </div>
                                                <div class="col-md-10">
                                                    <span for="patient_address" class="col-sm-3">Address</span>
                                                    <p class="col-sm-3"><?= $caregiver_info[0]->address ?></p>
                                                </div>
                                                <div class="col-md-10">
                                                        <span for="patient_joining_date"
                                                              class="col-sm-3">Joining Date</span>
                                                    <p class="col-sm-4"><?= $j_date = date("l, F j, Y", strtotime($caregiver_info[0]->joining_date)); ?></p>
                                                </div>
                                                <div class="col-md-10">
                                                    <span for="patient_address" class="col-sm-3">Stored Documents</span>
                                                    <p class="col-sm-3"><?php if($caregiver_info[0]->stored_document){echo $caregiver_info[0]->stored_document;}else{echo 'N/A';} ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <?php if ($financial_info) { ?>
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="tile-stats tile-primary">
                                                                        ...
                                                                        <div>
                                                                            <h4 style="color: white"><i
                                                                                        class="fa fa-gg"></i> Hourly Rate: <?= $financial_info['hourly_salary_rate'] ?>
                                                                            </h4>
                                                                        </div>
                                                                        <br>
                                                                        <div>
