                                        ...
                                        <div id="collapseOne-2" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <p class="col-sm-3"><?= $patient_info[0]->NID_number ?></p>
                                                </div>
                                                <div class="col-md-10">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <p class="col-sm-3"><?= $patient_info[0]->email ?></p>
                                                </div>
                                                <div class="col-md-10">
                                                            ...
                                                            <?php foreach ($f_contacts as $key => $row) { ?>
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <div class="tile-stats tile-primary">
                                                                        ...
                                                                        <div>
                                                                            <h4 style="color: white"><i
                                                                                    class="fa fa-location-arrow"></i> <?= $row->address ?>
                                                                            </h4>
                                                                        </div>
                                                                        <br>
                                                                        <div>
                                    ...
                                    <?php } else { ?>
                                        <?php foreach ($get_schedule as $key => $row) { ?>
                                            <tr>
                                                ...
                                                <td><?php $st = $row->end_time;
                                                    date_default_timezone_set('Asia/Dhaka');
                                                    $st = $st / 1000;
                                                    echo date('Y-m-d', $st); ?></td>
                                                <td><?php $st = $row->end_time;
                                                    date_default_timezone_set('Asia/Dhaka');
                                                    $st = $st / 1000;
                                                    echo date('h:i A', $st); ?></td>
...
//                    $("#filter_table").html(data);
        ...
        $(document).ready(function () {
           // create_history();
            ...
            var bar_chart = Morris.Bar({
                element: 'chart3',
                data: [{schedule_date: 0, carehours: 0},
                    {schedule_date: 0, carehours: 0},
                    {schedule_date: 0, carehours: 0},
                    {schedule_date: 0, carehours: 0}],
                xkey: 'schedule_date',
                ykeys: ['carehours'],
