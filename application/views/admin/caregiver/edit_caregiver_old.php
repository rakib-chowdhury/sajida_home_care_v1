        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form id="caregiver_edit_form" method="post" action="<?= site_url('caregiver/caregiver_edit_post') ?>"
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="basic_info">
                                ...
                                <div class="row">
                                    ...
                                    <input type="hidden" name="id" id="id" value="<?= $get_caregiver[0]['caregiver_user_id'] ?>">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="caregiver_dob" class="control-label">DOB</label>

                                            <div class="input-group">
                                                <input type="text" required class="form-control datepicker input-mini"
                                                       id="caregiver_dob"
                                                       name="caregiver_dob" readonly data-format="yyyy-mm-dd"
                                                       data-validate="required" <?php $new_date = explode('-', $get_caregiver[0]['DOB']); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="make-switch switch-small"
                                                <?php if ($get_caregiver[0]['gender'] == 1) { ?>
                                                    data-on-label='M'
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="phone_number"
                                               name="phone_number"
                                               required <?php if (isset($get_caregiver[0]['phone_number'])) { ?>
                                            value="<?= $get_caregiver[0]['phone_number'] ?>" <?php } ?>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="caregiver_address">Caregiver Address</label>
                                            <textarea class="form-control autogrow" name="caregiver_address"
                                                      ...
                                                      placeholder="Enter caregiver_address's address"><?php if (isset($get_caregiver[0]['address'])) { ?><?= $get_caregiver[0]['address'] ?><?php } ?></textarea>
                                    </div>
                                </div>
                            </div>
...
<!--                                               name="joining_date" readonly-->
<!--                                               data-validate="required" --><?php //$new_date = explode('-', $get_caregiver[0]['joining_date']); ?>
<!--                                               value="--><?//= $new_date[2] . '/' . $new_date[1] . '/' . $new_date[0] ?><!--"-->
<!--                                        >-->
<!---->
<!--                                        <div class="input-group-addon">-->
                                        ...
                                        <div>
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail"
                                                    ...
                                                    <img
                                                        src="<?= base_url() . 'uploads/caregiver_image/' . $get_caregiver[0]['picture'] ?>"
                                                        alt="...">
                                                </div>
                        ...
                        <div class="tab-pane" id="care_engagement">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input type="text" required class="form-control datepicker" id="joining_date"
                                               name="joining_date" readonly data-format="yyyy-mm-dd"
                                               data-validate="required" <?php $new_date = explode('-', $get_caregiver[0]['joining_date']); ?>
                                               value="<?= $new_date[2] . '/' . $new_date[1] . '/' . $new_date[0] ?>"
                                        >
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input type="text" required class="form-control" id="fixed_salary_rate"
                                               name="fixed_salary_rate" value="<?= $caregiver_salary[0]['fixed_salary_rate'] ?>"
                                               >
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input type="text" required class="form-control" id="hourly_salary_rate"
                                               name="hourly_salary_rate" value="<?= $caregiver_salary[0]['hourly_salary_rate'] ?>"
                                               >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <select name="payment_type" id="payment_type" onload="chk()" class="select2" data-validate="required"
                                                    data-allow-clear="true" data-placeholder="Select care plan...">
                                                <option value="Cash" <?php if($caregiver_salary[0]['payment_type'] == 'Cash'){echo 'selected';} ?>>Cash</option>
                                                <option value="Bank" <?php if($caregiver_salary[0]['payment_type'] == 'Bank'){echo 'selected';} ?>>Bank</option>
                                                <option value="Mobile" <?php if($caregiver_salary[0]['payment_type'] == 'Mobile'){echo 'selected';} ?>>Mobile</option>
                                            </select>
                                            <span id="payment_type_err"></span>
                                        </div>
                                    </div>
                                </div>
                                <input type="hidden" name="check_payment" id="check_payment" value="<?= $caregiver_salary[0]['payment_type'] ?>">
                                <input type="hidden" name="salary_id" id="salary_id" value="<?= $caregiver_salary[0]['caregiver_salary_id'] ?>">
<!--                                --><?php //if($caregiver_salary[0]['payment_type'] == 'Mobile'){ ?>
                                <div class="col-md-4" id="mobile_div" hidden>
                                    <div class="form-group">
                                        <label for="bank_account_number" class="control-label">Mobile</label>
                                        <div>
                                            <input type="number" class="form-control" id="mobile_payment_number"
                                                   name="mobile_payment_number" value="<?php if(isset($caregiver_salary[0]['mobile_payment_number'])){echo $caregiver_salary[0]['mobile_payment_number'];} ?>"
...
<!--                                --><?php //if($caregiver_salary[0]['payment_type'] == 'Bank'){ ?>
                                    <div class="col-md-4" id="bank_div" hidden>
                                        <div class="form-group">
                                            <label for="bank_account_number" class="control-label">Bank</label>
                                            <div>
                                                <input type="text" class="form-control" id="bank_account_number"
                                                       name="bank_account_number" value="<?php if(isset($caregiver_salary[0]['bank_account_number'])){echo $caregiver_salary[0]['bank_account_number'];}  ?>"
...
<!--                                --><?php //} ?>
                        ...
                        <div class="tab-pane" id="contacts">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="emergency_contact_name"
                                               ...
                                               placeholder="Enter name" value="<?= $emergency_contact[0]['family_contact_name'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="emergency_contact_relationship"
                                               ...
                                               placeholder="Son, daughter or etc." value="<?= $emergency_contact[0]['relationship'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="emergency_contact_phone"
                                               ...
                                               placeholder="Enter phone number" value="<?= $emergency_contact[0]['phone_number'] ?>">
                                    </div>
                                </div>
                                ...
                                <input type="hidden" id="emergency_contact" name="emergency_contact" value="<?= $emergency_contact[0]['caregiver_family_contact_id'] ?>">
                            ...
                            <div class="row">
                                <input type="hidden" name="contact1_id" id="contact1_id" value="<?php if(isset($family_contact_id_1)){echo $family_contact_id_1;} ?>">
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="family_contact_relationship_1"
                                               name="family_contact_relationship_1" <?php if (isset($family_contact_relationship_1)){ ?>
                            ...
                            <div class="row">
                                <input type="hidden" name="contact2_id" id="contact2_id" value="<?php if(isset($family_contact_id_2)){echo $family_contact_id_2;}  ?>">
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="family_contact_relationship_2"
                                               name="family_contact_relationship_2" <?php if (isset($family_contact_relationship_2)){ ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="family_contact_phone_2"
                                               name="family_contact_phone_2" placeholder="Enter phone number"
                                            <?php if (isset($family_contact_phone_2)){ ?>
                            ...
                            <div class="row">
                                <input type="hidden" name="contact3_id" id="contact3_id" value="<?php if(isset($family_contact_id_3)){echo $family_contact_id_3;} ?>">
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="family_contact_relationship_3"
                                               name="family_contact_relationship_3" <?php if (isset($family_contact_relationship_3)){ ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="family_contact_phone_3"
                                               name="family_contact_phone_3" placeholder="Enter phone number"
                                            <?php if (isset($family_contact_phone_3)){ ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="family_contact_email_3"
                                            ...
                                            <?php if (isset($family_contact_email_3)){ ?>
