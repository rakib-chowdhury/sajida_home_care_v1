        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <?php } ?>
                    <table class="table table-bordered table-responsive" id="table-1" width="100%">
                        <thead>
                        <tr>
                            <th>Picture</th>
                            <th>Name</th>
                        ...
                        <tbody>
                        <?php if (sizeof($get_caregiver_info) != null) { ?>
                            <?php foreach ($get_caregiver_info as $key => $row) { ?>
                                <tr>
                                    ...
                                    ?>"
                                         class="img-circle" alt="Go To Profile" height="60" width="60">
                                    <?php }else{ ?>
                                    <img src="<?= base_url() ?>uploads/caregiver_image/no_image.jpg"
                                         class="img-circle" alt="Go To Profile" height="60" width="60">
                                    <?php } ?>
                                            <span><br><?= $row['caregiver_user_id'] ?></span>
                                        </a>
                                    </td>
                                    <td><a href="<?= site_url('caregiver/view_profile') . '/' . $row['caregiver_user_id'] ?>">
                                            <?= $row['caregiver_name'] ?>
                                    ...
                                    <td><?= $row['cg_phone'] ?></td>
                                    <td>
                                        <a href="<?= site_url('caregiver/edit_caregiver') . '/' . $row['caregiver_user_id'] ?>">
                                            <span data-toggle="tooltip" data-placement="top" title="Edit"
                                                  class="glyphicon glyphicon-edit"></span>
                                        </a>
                                        <a data-toggle="modal" data-target="#statusModal_<?= $row['caregiver_user_id'] ?>"> <?php if($row['status'] == 1){ ?>
                                        ...
                                        <a data-toggle="modal" data-target="#passwordModal_<?= $row['caregiver_user_id'] ?>">
                                            <span data-toggle="tooltip" data-placement="top" title="Reset Password"
                                                  class="glyphicon glyphicon-lock"></span>
                                        </a>
                                    </td>
                                    <div class="modal fade" id="passwordModal_<?= $row['caregiver_user_id'] ?>"
                                         data-backdrop="static">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form role="form"
                                                      action="<?= site_url('caregiver/reset_password')?>"
                                                      class="form-horizontal form-groups-bordered" method="post">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Reset Password For <strong><?= $row['caregiver_name'] ?></strong></h4>
                                                    </div>
                                                    ...
                                                    <div>
                                                        <input type="hidden" id="password_id" name="password_id" value="<?= $row['caregiver_user_id'] ?>">
                                                    </div>
                                    ...
                                    <div class="modal fade" id="statusModal_<?= $row['caregiver_user_id'] ?>"
                                         data-backdrop="static">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form role="form"
                                                      action="<?= site_url('caregiver/change_status')?>"
                                                      class="form-horizontal form-groups-bordered" method="post">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Change Status For <strong><?= $row['caregiver_name'] ?></strong></h4>
                                                    </div>
                                                    <div class="modal-body">
                                                    ...
                                                    <div>
                                                        <input type="hidden" id="status_id" name="status_id" value="<?= $row['caregiver_user_id'] ?>">
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-success">Yes
                                                        </button>
