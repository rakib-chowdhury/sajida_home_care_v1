                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="make-switch switch-small"
                                                 data-on-label="<?php if ($patient_info[0]['gender'] == 1) {
                                                     echo 'M';
                                                 } ?>" data-off-label="<?php if ($patient_info[0]['gender'] == 1) {
                                                echo 'F';
                                            } ?>">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="family_contact_name_1"
                                                   name="family_contact_name_1" <?php if (isset($family_contact_name_1)) { ?>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="family_contact_relationship_1"
                                                ...
                                                <?php if (isset($family_contact_relationship_1)) { ?>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="family_contact_phone_1"
                                                   name="family_contact_phone_1" <?php if (isset($family_contact_phone_1)) { ?>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="family_contact_email_1"
                                                   name="family_contact_email_1" <?php if (isset($family_contact_email_1)) { ?>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="family_contact_name_2"
                                                   name="family_contact_name_2" <?php if (isset($family_contact_name_2)){ ?>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="family_contact_relationship_2"
                                                ...
                                                <?php if (isset($family_contact_relationship_2)) { ?>
                                                    value="<?= $family_contact_relationship_2 ?>" <?php } else { ?>placeholder="Enter Relationship" <?php } ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="family_contact_phone_2"
                                                   name="family_contact_phone_2" <?php if (isset($family_contact_phone_2)){ ?>
                                                value="<?= $family_contact_phone_2 ?>" <?php } else{ ?>
                                                   placeholder="Enter Phone"><?php } ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="family_contact_email_2"
                                                   name="family_contact_email_2" <?php if (isset($family_contact_email_2)) { ?>
                                                value="<?= $family_contact_email_2 ?>" <?php } else { ?> placeholder="Enter Email"
                                            <?php } ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control autogrow" name="family_contact_address_2"
                                                      id="family_contact_address_2"><?php if (isset($family_contact_address_2)) {
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="family_contact_name_3"
                                                   name="family_contact_name_3" <?php if (isset($family_contact_name_3)) { ?>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="family_contact_relationship_3"
                                                ...
                                                <?php if (isset($family_contact_relationship_3)) { ?>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="family_contact_phone_3"
                                                   name="family_contact_phone_3" <?php if (isset($family_contact_phone_3)) { ?>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="family_contact_email_3"
                                                   name="family_contact_email_3" <?php if (isset($family_contact_email_3)) { ?>
