                ...
                <div class="panel-body">
                    <div class="form-group">
                        <table class="table table-bordered datatable" id="table-1"
                            ...
                            <tbody>
                            <?php foreach ($consultants as $key => $row) { ?>
                                <tr>
                                    <td><a href="#"
                                           onclick="get_schedule('<?= $row->consultant_user_id ?>')"><?= $row->name ?>
                ...
                <div class="panel-body">
                    ...
                    <div id="clockingModal" class="modal fade"
                        ...
                        <div class="modal-dialog">
                            ...
                            <!-- Modal content-->
                            <form action="<?= base_url() ?>Schedule/con_clocking_add_post"
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="c_name" class="control-label">Consultant
                                                        Name</label>
                                        ...
                                        <input type="hidden" id="c_consultant_id" name="c_consultant_id">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="hidden" id="clocking_start" name="clocking_start">
                                            <div class="col-md-6">
                                                <div class="form-group">
